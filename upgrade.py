...
class Upgrade(Sprite):
    ...
    def __init__(self, screen, settings, pipes, bricks, x, y, up_type):
        ...
        self.mushroom = "resources/Mushroom.png"
        self.fireflower = "resources/Fire_Flower.png"
        self.life_mushroom = "resources/1UP_Mushroom.png"
        self.star = "resources/Star.png"
        self.coin = "resources/Coin.png"
        if self.up_type == 0:
